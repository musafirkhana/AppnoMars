 ...
 */
public class MultiDialog extends DialogFragment implements View.OnClickListener, ListView.OnItemClickListener{
    ...
    public static MultiDialog newInstance(String title, ArrayList<String> dialogItems, String negativeButton, String positiveButton) {
        MultiDialog f = new MultiDialog();
