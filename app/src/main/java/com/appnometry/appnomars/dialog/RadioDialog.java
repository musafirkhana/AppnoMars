 ...
 */
public class RadioDialog extends DialogFragment implements View.OnClickListener, ListView.OnItemClickListener{
    ...
    public static RadioDialog newInstance(String title, ArrayList<String> radioItems, String negativeButton, String positiveButton) {
        RadioDialog f = new RadioDialog();
