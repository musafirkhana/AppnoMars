package com.appnometry.appnomars.dialog;
...
import com.appnometry.appnomars.adapter.Dialog_Multi_Adapter;
 ...
 */
public class SingleDialog extends DialogFragment implements View.OnClickListener, ListView.OnItemClickListener{
    ...
    public static SingleDialog newInstance(String title, ArrayList<String> dialogItems, String negativeButton, String positiveButton, MyDialogListener dialogListener) {
        SingleDialog f = new SingleDialog();
