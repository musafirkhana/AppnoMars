...
public class NewsFeedAdapter extends ArrayAdapter<GlobalItemListModel> {
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        if (position < AllGlobalItemList.getAllNewsFeedList().size()) {
            ...
            /**************************Separationg Four Types of View****************************/
            if (query.getItem_type().equalsIgnoreCase("News Item")) {
                holder.nf_price.setVisibility(View.GONE);
                holder.top_separator.setVisibility(View.GONE);
                holder.title_imageview.setImageDrawable(getContext().getResources().getDrawable(R.drawable.menu_news_feed_active));
            } else if (query.getItem_type().equalsIgnoreCase("Event")) {
                holder.nf_price.setVisibility(View.GONE);
                holder.top_separator.setVisibility(View.GONE);
                holder.title_imageview.setImageDrawable(getContext().getResources().getDrawable(R.drawable.menu_events_active));
            } else if (query.getItem_type().equalsIgnoreCase("Coupon")) {

                holder.title_imageview.setImageDrawable(getContext().getResources().getDrawable(R.drawable.menu_coupons_active));
            } else if (query.getItem_type().equalsIgnoreCase("Benefit")) {

                holder.title_imageview.setImageDrawable(getContext().getResources().getDrawable(R.drawable.menu_deals_active));
            }
